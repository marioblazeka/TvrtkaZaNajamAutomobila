...
(1, STR_TO_DATE('2024-05-31', '%Y-%m-%d'), 175.00, 'ABC1234', 175.00), -- gotovina
(2, STR_TO_DATE('2024-06-01', '%Y-%m-%d'), 210.50, 'DEF5678', 210.50), -- gotovina
(3, STR_TO_DATE('2024-06-02', '%Y-%m-%d'), 85.25, 'GHI9012', 85.25),   -- gotovina
(4, STR_TO_DATE('2024-06-03', '%Y-%m-%d'), 120.00, 'JKL3456', 120.00), -- gotovina
(5, STR_TO_DATE('2024-06-04', '%Y-%m-%d'), 340.75, 'MNO7890', 340.75), -- gotovina
(6, STR_TO_DATE('2024-06-05', '%Y-%m-%d'), 65.50, 'PQR1234', 65.50),   -- gotovina
(7, STR_TO_DATE('2024-06-06', '%Y-%m-%d'), 100.00, 'STU5678', 100.00), -- gotovina
(8, STR_TO_DATE('2024-06-07', '%Y-%m-%d'), 130.25, 'VWX9012', 130.25), -- gotovina
(9, STR_TO_DATE('2024-06-08', '%Y-%m-%d'), 200.75, 'YZA3456', 200.75), -- gotovina
(10, STR_TO_DATE('2024-06-09', '%Y-%m-%d'), 270.00, 'BCD7890', 270.00), -- gotovina
(11, STR_TO_DATE('2024-06-10', '%Y-%m-%d'), 350.50, 'EFG1234', 350.50), -- gotovina
(12, STR_TO_DATE('2024-06-11', '%Y-%m-%d'), 100.25, 'HIJ5678', 100.25), -- gotovina
(13, STR_TO_DATE('2024-06-12', '%Y-%m-%d'), 170.75, 'KLM9012', 170.75), -- gotovina
(14, STR_TO_DATE('2024-06-13', '%Y-%m-%d'), 220.00, 'NOP3456', 220.00), -- gotovina
(15, STR_TO_DATE('2024-06-14', '%Y-%m-%d'), 105.50, 'QRS7890', 105.50), -- kartica
(16, STR_TO_DATE('2024-06-15', '%Y-%m-%d'), 145.25, 'TUV1234', 145.25), -- kartica
(17, STR_TO_DATE('2024-06-16', '%Y-%m-%d'), 190.75, 'WXY5678', 190.75), -- kartica
(18, STR_TO_DATE('2024-06-17', '%Y-%m-%d'), 240.00, 'ZAB9012', 240.00), -- kartica
(19, STR_TO_DATE('2024-06-18', '%Y-%m-%d'), 80.50, 'CDE3456', 80.50),   -- kartica
(20, STR_TO_DATE('2024-06-19', '%Y-%m-%d'), 190.25, 'FGH7890', 190.25), -- kartica
(21, STR_TO_DATE('2024-06-20', '%Y-%m-%d'), 325.75, 'IJK1234', 325.75), -- kartica
(22, STR_TO_DATE('2024-06-21', '%Y-%m-%d'), 70.00, 'LMN5678', 70.00),   -- kartica
(23, STR_TO_DATE('2024-06-22', '%Y-%m-%d'), 120.50, 'OPQ9012', 120.50), -- kartica
(24, STR_TO_DATE('2024-06-23', '%Y-%m-%d'), 180.25, 'RST3456', 180.25), -- kriptovaluta
(25, STR_TO_DATE('2024-06-24', '%Y-%m-%d'), 140.75, 'UVW7890', 140.75), -- kriptovaluta
(26, STR_TO_DATE('2024-06-25', '%Y-%m-%d'), 215.00, 'XYZ1234', 215.00), -- kriptovaluta
(27, STR_TO_DATE('2024-06-26', '%Y-%m-%d'), 90.50, 'ABC5678', 90.50),   -- kriptovaluta
(28, STR_TO_DATE('2024-06-27', '%Y-%m-%d'), 200.25, 'DEF9012', 200.25), -- kriptovaluta
(29, STR_TO_DATE('2024-06-28', '%Y-%m-%d'), 150.75, 'GHI3456', 150.75), -- kriptovaluta
(30, STR_TO_DATE('2024-06-29', '%Y-%m-%d'), 220.00, 'JKL7890', 220.00); -- kriptovaluta
