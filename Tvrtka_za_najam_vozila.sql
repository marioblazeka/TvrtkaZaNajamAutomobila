...
CREATE TABLE popust (
    id TINYINT NOT NULL AUTO_INCREMENT, 
    tip_popusta VARCHAR(100) NOT NULL,
    PRIMARY KEY (id)
);
...
INSERT INTO klijent (id, ime, prezime, identifikacijski_broj, id_pravna_osoba) VALUES -- Mirela, Sebastijan
(1, 'Luka', 'Novosel', '1234567890123', NULL),
(2, 'Ana', 'Kovačević', '2345678901234', NULL),
(3, 'Ivan', 'Horvat', '3456789012345', 3),
(4, 'Petra', 'Marić', '4567890123456', NULL),
(5, 'Marko', 'Pavić', '5678901234567', NULL),
(6, 'Martina', 'Knežević', '6789012345678', NULL),
(7, 'Nikola', 'Perić', '7890123456789', 8),
(8, 'Kristina', 'Jurić', '8901234567890', 2),
(9, 'Filip', 'Kovačić', '9012345678901', 9),
(10, 'Ivana', 'Šimunović', '0123456789012', NULL),
(11, 'Ivo', 'Horvat', '9876543210987', NULL),
(12, 'Maja', 'Petrović', '8765432109876', 7),
(13, 'Lucija', 'Novak', '7654321098765', NULL),
(14, 'Matej', 'Šimić', '6543210987654', 1),
(15, 'Ana', 'Kovač', '5432109876543', NULL),
(16, 'Petar', 'Ilić', '4321098765432', NULL),
(17, 'Lana', 'Horvat', '3210987654321', 8),
(18, 'Ivan', 'Pavić', '2109876543210', NULL),
(19, 'Marija', 'Kovačević', '1098765432109', 9),
(20, 'Ante', 'Marinović', '0987654321098', NULL),
(21, 'Lucija', 'Perić', '0192837465029', NULL),
(22, 'Matija', 'Knežević', '1827364550912', NULL),
(23, 'Luka', 'Horvat', '2748192650374', NULL),
(24, 'Iva', 'Pavić', '3647281902748', NULL),
(25, 'Petra', 'Jurić', '4567382910563', 10),
(26, 'Ivan', 'Kovačić', '5126347890123', NULL),
(27, 'Martina', 'Marinović', '6748291028473', 8),
(28, 'Nikola', 'Horvat', '7456128390471', NULL),
(29, 'Elena', 'Novak', '8192736450128', NULL),
(30, 'Roko', 'Knežević', '9283746510293', NULL);
...
(2, "Marketinški direktor", "Vođenje odjela za marketing, donošenje odluka o ulaganjima u kampanje, razmatranje širenja tržišta, istraživanje raznih tržišta", "Marketing"),
(3, "Istražitelj tržišta", "Fizičko istraživanje novih tržišta u svrhu razmatranja širenja u ista", "Marketing"),
(4, "Računovođa", "Knjiženje računa", "Računovodstvo"),
(5, "Direktor Računovodstva", "Vođenje odjela za računovodstvo, plaćanje računa, isplata prihoda zaposlenicima", "Računovodstvo"),
(6, "Rukovoditelj ljudskih resursa", "Vođenje odjela za ljudske resurse, pronalaženje novih talenata", "Ljudski resursi"),
...
INSERT INTO zaposlenik (id, id_nadredeni_zaposlenik, ime, prezime, identifikacijski_broj, spol, broj_mobitela, broj_telefona, email, id_zanimanje, id_lokacija) VALUES  -- Mirela 
...
INSERT INTO kontakt_klijenta (id, email, broj_mobitela, broj_telefona, id_klijent) VALUES -- Mirela, Sebastijan
...
(11, 'ivo.horvat@gmail.com', '0912345670', '0924567890', 11),
(12, 'maja.petrovic@gmail.com', '0923456781', '0935678901', 12),
(13, 'lucija.novak@gmail.com', '0934567892', '0946789012', 13),
(14, 'matej.simic@gmail.com', '0945678903', '0957890123', 14),
(15, 'ana.kovac@gmail.com', '0956789014', '0968901234', 15),
(16, 'petar.ilic@gmail.com', '0967890125', '0979012345', 16),
(17, 'lana.horvat@gmail.com', '0978901236', '0980123456', 17),
(18, 'ivan.pavic@gmail.com', '0989012347', '0991234567', 18),
(19, 'marija.kovacevic@gmail.com', '0990123458', '0912345671', 19),
(20, 'ante.marinovic@gmail.com', '0912345672', '0923456782', 20),
(21, 'lucija.peric@gmail.com', '0923456783', '0934567893', 21),
(22, 'matija.knezevic@gmail.com', '0934567894', '0945678904', 22),
(23, 'luka.horvat@gmail.com', '0945678905', '0956789015', 23),
(24, 'iva.pavic@gmail.com', '0956789016', '0967890126', 24),
(25, 'petra.juric@gmail.com', '0967890127', '0978901237', 25),
(26, 'ivan.kovacic@gmail.com', '0978901238', '0989012348', 26),
(27, 'martina.marinovic@gmail.com', '0989012349', '0990123459', 27),
(28, 'nikola.horvat@gmail.com', '0990123460', '0912345673', 28),
(29, 'elena.novak@gmail.com', '0912345674', '0923456784', 29),
(30, 'roko.knezevic@gmail.com', '0923456785', '0934567895', 30);
...
(5, STR_TO_DATE('2024-05-08', '%Y-%m-%d'), 300.75, 'MNO7890', 300.75, 5, 24),
(6, STR_TO_DATE('2024-05-06', '%Y-%m-%d'), 51.50, 'PQR1234', 50.50, 6, 1),
...
(10, STR_TO_DATE('2024-05-10', '%Y-%m-%d'), 250.00, 'BCD7890', 250.00, 10, 1),
...
(16, STR_TO_DATE('2024-05-16', '%Y-%m-%d'), 130.25, 'TUV1234', 130.25, 16, 24),
...
(23, STR_TO_DATE('2024-05-23', '%Y-%m-%d'), 110.50, 'OPQ9012', 110.50, 23, 1),
...
(31, STR_TO_DATE('2024-05-01', '%Y-%m-%d'), 250.00, 'ABP1034', 250.00, 12, 24),
(32, STR_TO_DATE('2024-05-02', '%Y-%m-%d'), 300.50, 'DOF5608', 300.50, 12, 2), 
(33, STR_TO_DATE('2024-05-03', '%Y-%m-%d'), 175.25, 'GHI9012', 175.25, 11, 3), 
(34, STR_TO_DATE('2024-04-04', '%Y-%m-%d'), 220.00, 'JKZ3456', 220.00, 4, 4), 
(35, STR_TO_DATE('2024-05-05', '%Y-%m-%d'), 180.75, 'MIO7590', 180.75, 9, 1); 
...
(4, STR_TO_DATE('2024-03-04', '%Y-%m-%d'), STR_TO_DATE('2024-03-15', '%Y-%m-%d'), 'iskorišten', 1, 18),
(5, STR_TO_DATE('2024-05-05', '%Y-%m-%d'), NULL, 'aktivan', 5, 11),
(6, STR_TO_DATE('2024-03-06', '%Y-%m-%d'), STR_TO_DATE('2024-03-20', '%Y-%m-%d'), 'iskorišten', 4, 24),
(7, STR_TO_DATE('2024-04-07', '%Y-%m-%d'), STR_TO_DATE('2024-04-22', '%Y-%m-%d'), 'iskorišten', 7, 25),
(8, STR_TO_DATE('2024-05-08', '%Y-%m-%d'), NULL, 'aktivan', 3, 17),
(9, STR_TO_DATE('2024-05-09', '%Y-%m-%d'), NULL, 'aktivan', 4, 5),
(10, STR_TO_DATE('2024-05-10', '%Y-%m-%d'), NULL, 'aktivan', 10, 6),
(11, STR_TO_DATE('2024-05-11', '%Y-%m-%d'), NULL, 'aktivan', 11, 9),
(12, STR_TO_DATE('2024-05-12', '%Y-%m-%d'), STR_TO_DATE('2024-05-25', '%Y-%m-%d'), 'iskorišten', 4, 1),
(13, STR_TO_DATE('2024-05-13', '%Y-%m-%d'), NULL, 'aktivan', 13, 2),
(14, STR_TO_DATE('2024-05-14', '%Y-%m-%d'), NULL, 'aktivan', 3, 28),
(15, STR_TO_DATE('2024-05-15', '%Y-%m-%d'), NULL, 'aktivan', 4, 20),
...
(19, STR_TO_DATE('2024-05-19', '%Y-%m-%d'), STR_TO_DATE('2024-05-30', '%Y-%m-%d'), 'iskorišten', 3, 12),
...
(22, STR_TO_DATE('2024-05-22', '%Y-%m-%d'), NULL, 'aktivan', 3, 7),
(23, STR_TO_DATE('2024-05-23', '%Y-%m-%d'), NULL, 'aktivan', 1, 21),
...
(26, STR_TO_DATE('2024-05-26', '%Y-%m-%d'), NULL, 'aktivan', 3, 27),
(27, STR_TO_DATE('2024-05-27', '%Y-%m-%d'), NULL, 'aktivan', 1, 14),
(28, STR_TO_DATE('2024-05-28', '%Y-%m-%d'), NULL, 'aktivan', 28, 16),
(29, STR_TO_DATE('2024-05-29', '%Y-%m-%d'), NULL, 'aktivan', 3, 23),
...
(3, 29, 'Korištenje vozila u nezakonite svrhe'),
...
-- Mirela
-- 1.	PRIKAŽI 3 KLIJENTA S NAJVIŠE POTROŠENOG NOVCA NA NAJAM VOZILA I OPREME
SELECT k.id AS id_klijent,
    CONCAT(k.ime, ' ', k.prezime) AS ime_prezime_klijenta,
    SUM(t.iznos) AS ukupni_iznos
FROM klijent k
INNER JOIN transakcija t ON k.id = t.id_klijent
INNER JOIN najam_vozila nv ON t.id = nv.id_transakcija_najam
...
-- 2.   PRIKAZI 5 VRSTA DODATNE OPREMU KOJA SE NAJMANJE PUTA IZNAJMILA
...
-- 3.  PROVJERA NAJMA VOZILA KOJI CU PREMAŠILI BROJKU OD 100 KILOMETARA
...
-- 4.  PRIKAŽI SVE POSLOVNE TROŠKOVE ZA REZERVACIJE KOJE SU SE DOGODILE U PRVIH 6 MJESECI U 2024.GOD
SELECT pt.* 
...
-- 5. PRONAĐI BROJ NAJMOVA VOZILA PO DRŽAVI SJEDIŠTA PRAVNE OSOBE
SELECT l.drzava AS Drzava, COUNT(nv.id) AS Broj_Najmova
FROM pravna_osoba p
INNER JOIN klijent k ON p.id = k.id_pravna_osoba
INNER JOIN transakcija t ON k.id = t.id_klijent
INNER JOIN najam_vozila nv ON t.id = nv.id_transakcija_najam
INNER JOIN lokacija l ON p.id_lokacija = l.id
WHERE YEAR(nv.datum_pocetka) = 2024
GROUP BY l.drzava
ORDER BY Broj_Najmova DESC;


-- 6.  PRIKAŽI TROŠKOVE NAJMA VOZILA PO ZAPOSLENIKU
...
FROM zaposlenik z
INNER JOIN transakcija t ON z.id = t.id_zaposlenik
INNER JOIN najam_vozila nv ON t.id = nv.id_transakcija_najam
...
-- 7.PRIKAŽI TRAJANJA NAJMA VOZILA ZA KLIJENTE U 2024. GODINI OD NAJDUŽIH PREMA NAJKRAĆIM NAJMOVIMA
(SELECT k.ime, k.prezime, 
        nv.datum_pocetka, nv.datum_zavrsetka,
        DATEDIFF(nv.datum_zavrsetka, nv.datum_pocetka) AS trajanje,
        'Prvo tromjesečje 2024.' AS razdoblje
 FROM najam_vozila nv
 INNER JOIN transakcija t ON nv.id_transakcija_najam = t.id
 INNER JOIN klijent k ON t.id_klijent = k.id
 WHERE YEAR(nv.datum_pocetka) = 2024 AND MONTH(nv.datum_pocetka) <= 3)
...
(SELECT k.ime, k.prezime, 
        nv.datum_pocetka, nv.datum_zavrsetka,
        DATEDIFF(nv.datum_zavrsetka, nv.datum_pocetka) AS trajanje,
        'Drugo tromjesečje 2024.' AS razdoblje
 FROM najam_vozila nv
 INNER JOIN transakcija t ON nv.id_transakcija_najam = t.id
 INNER JOIN klijent k ON t.id_klijent = k.id
 WHERE YEAR(nv.datum_pocetka) = 2024 AND MONTH(nv.datum_pocetka) > 3 AND MONTH(nv.datum_pocetka) <= 6)
...
-- UPIT 1
-- Prikaži pet vozila koja su napravila najveću kilometražu, period kad su bili iznajmljeni. Rezultate grupirati po vozilu, a vrijednost kilometraže sortirati silazno.
-- Cilj: Praćenje kilometraže zbog redovitog oddržavanja vozila i zamjene dijelova kako bismo osigurali sigurnost i pouzdanost vozila.
SELECT 
    nv.id_vozilo AS 'ID vozila',
    SUM(nv.zavrsna_kilometraza - nv.pocetna_kilometraza) AS 'Kilometraža',
    MIN(nv.datum_pocetka) AS 'Datum početka najma',
    MAX(nv.datum_zavrsetka) AS 'Datum završetka najma'
FROM 
    najam_vozila nv
GROUP BY 
    nv.id_vozilo
ORDER BY 
    SUM(nv.zavrsna_kilometraza - nv.pocetna_kilometraza) DESC
LIMIT 5;

-- UPIT 2
-- Prikaži sve klijente koji su rezervirali automobil u periodu od 01. travnja do 31. listopada 2023. godine, s podacima o seriji i tipu vozila, podaci poredani po datumu uzlazno.
-- Cilj: Praćenje klijenata koji su izvršili rezervacije u periodu turističke sezone.
SELECT 
    k.id AS 'ID klijenta',
    k.ime AS 'Ime',
    k.prezime AS 'Prezime',
    k.identifikacijski_broj AS 'Identifikacijski broj',
    r.datum_rezervacije AS 'Datum rezervacije',
    s.ime AS 'Serija vozila',
    v.tip_vozila AS 'Tip vozila'
FROM 
    rezervacija r
JOIN 
    klijent k ON r.id_klijent = k.id
JOIN 
    vozilo_na_rezervaciji vr ON r.id = vr.id_rezervacija
JOIN 
    vozilo v ON vr.id_vozilo = v.id
JOIN 
    serija s ON v.id_serija = s.id
WHERE 
    r.datum_rezervacije BETWEEN '2023-04-01' AND '2023-10-31' AND v.tip_vozila = 'A'
ORDER BY 
    r.datum_rezervacije ASC;

-- UPIT 3
-- Prikaži vozila koja imaju električno punjenje, broj njihovih najmova i broj rezervacija, datume početka i završetka najma te podatak o broju dana najma.
-- Cilj je prikazati koliko se i u kojem periodu koriste ekološki najprihvatljivija vozila.
SELECT 
    v.id AS 'ID vozila', s.ime AS 'Naziv serije', v.tip_punjenja AS 'Tip punjenja',
    COUNT(nv.id) AS 'Broj najmova',
    (
        SELECT COUNT(r.id)
        FROM rezervacija r
        JOIN vozilo_na_rezervaciji vr ON r.id = vr.id_rezervacija
        WHERE vr.id_vozilo = v.id
    ) AS 'Broj rezervacija',
    (
        SELECT GROUP_CONCAT(DISTINCT datum_pocetka SEPARATOR ', ')
        FROM najam_vozila
        WHERE id_vozilo = v.id
    ) AS 'Datum početka najma',
    (
        SELECT GROUP_CONCAT(DISTINCT datum_zavrsetka SEPARATOR ', ')
        FROM najam_vozila WHERE id_vozilo = v.id
    ) AS 'Datum završetka najma',
    (
        SELECT SUM(DATEDIFF(datum_zavrsetka, datum_pocetka)) FROM najam_vozila
        WHERE id_vozilo = v.id
    ) AS 'Broj dana najma'
FROM vozilo v
JOIN serija s ON v.id_serija = s.id
LEFT JOIN najam_vozila nv ON v.id = nv.id_vozilo
WHERE v.tip_punjenja = 'Električno'
GROUP BY v.id, s.ime;
    
-- UPIT 4
-- Prikaži sva vozila koja su imala štetu, ali da je tip štete krađa. Također prikaži datum početka i završetka nastanka štete te iznosa koji je pokrio štetu, sortiran po iznosu transakcije silazno.
-- Cilj: Dobiti uvid koji automobili se najviše kradu ili se iz njih krade, i u kojem periodu, te donošenje preventivnih mjera za smanjenje broja krađa, a shodno tome i smanjenje troškova.
SELECT
    vozilo.id AS 'ID vozila',
    serija.ime AS 'Naziv vozila',
    steta.tip AS 'Tip štete',
    steta.opis AS 'Opis štete',
    naknada_stete.id AS 'ID naknade štete',
    naknada_stete.datum_pocetka AS 'Datum početka',
    naknada_stete.datum_zavrsetka AS 'Datum završetka',
    transakcija.iznos AS 'Iznos transakcije'
FROM 
    (SELECT DISTINCT id, id_serija FROM vozilo) vozilo
JOIN 
    najam_vozila ON vozilo.id = najam_vozila.id_vozilo
JOIN 
    naknada_stete ON najam_vozila.id = naknada_stete.id_transakcija
JOIN 
    steta ON naknada_stete.id_steta = steta.id
JOIN 
    serija ON vozilo.id_serija = serija.id
JOIN 
    transakcija ON naknada_stete.id_transakcija = transakcija.id
WHERE 
    steta.tip = 'Krađa'
ORDER BY 
    transakcija.iznos DESC;
    
-- UPIT 5
-- Prikaži 5 zaposlenika koji su ostvarili najveći prihod u zadnjoj godini dana, sortiraj po ukupnom prihodu silazno.
-- Prikaži i dodatne stupce s brojem transakcija i najmova koje su ostvarili.
-- Cilj: Dobiti uvid u zaposlenike koji ostvaruju najviše transakcija i najviše najmova, te njihov ostvareni prihod (najprofitabilniji zaposlenik).

SELECT 
    z.id AS zaposlenik_id, 
    z.ime AS zaposlenik_ime, 
    z.prezime AS zaposlenik_prezime, 
    z.email AS zaposlenik_email, 
    l.drzava AS lokacija_drzava, 
    l.grad AS lokacija_grad, 
    l.adresa AS lokacija_adresa, 
    SUM(t.iznos) AS ukupni_prihod,
    COUNT(t.id) AS broj_transakcija,
    COUNT(DISTINCT t.id) AS broj_najmova
FROM 
    zaposlenik z
JOIN 
    transakcija t ON z.id = t.id_zaposlenik
JOIN 
    prihod_za_zaposlenika pz ON t.id = pz.id_transakcija_prihoda
JOIN 
    prihod p ON pz.id_prihod = p.id
JOIN 
    lokacija l ON z.id_lokacija = l.id
WHERE 
    t.datum >= DATE_SUB(CURDATE(), INTERVAL 1 YEAR)
GROUP BY 
    z.id, z.ime, z.prezime, z.email, l.drzava, l.grad, l.adresa
ORDER BY 
    ukupni_prihod DESC
LIMIT 5;

-- UPIT 6
-- Prikaži sva plaćanja izvršena kriptovalutnim načinom plaćanja, datum kad su izvršena i od strane kojeg klijenta.
-- Cilj: Praćenje popularnosti kriptovaluta među klijentima.
...
SELECT 
    ...
    t.id_zaposlenik,
    k.kriptovaluta,
    k.broj_kripto_novcanika,
    CONCAT(kl.ime,' ', kl.prezime) AS puno_ime_klijenta
FROM 
    transakcija t
JOIN 
    kriptovalutno_placanje k ON t.id = k.id
JOIN 
    klijent kl ON t.id_klijent = kl.id
ORDER BY 
    t.datum DESC;
    
-- UPIT 7
-- Prikaži klijente koji su ostvarili najveći broj popusta, i posebno tablicu u kojoj je vidljivo koliko je aktivnih, a koliko neaktivnih popusta
-- Cilj: Praćenje lojalnosti kupca i planiranje budućih promocija.
SELECT 
    CONCAT(k.ime, ' ', k.prezime) AS klijent,
    COUNT(pk.id) AS broj_popusta,
    SUM(CASE WHEN pk.status = 'aktivan' THEN 1 ELSE 0 END) AS broj_aktivnih_popusta,
    SUM(CASE WHEN pk.status = 'iskorišten' THEN 1 ELSE 0 END) AS broj_iskorištenih_popusta
FROM 
    klijent k
JOIN 
    popust_za_klijenta pk ON k.id = pk.id_klijent
GROUP BY 
    k.ime, k.prezime
ORDER BY 
    broj_popusta DESC
...
-- UPIT 8
-- Prikkaži sve zaposlenice ženskog spola, države u kojoj rade, njihova zanimanja, e-mail i broj transakcija u zadnjih 6 mjeseci. Sve sortirano po imenu zaposlenica.
-- Cilj: Osim upućivanja svim zaposlenicama čestitke za Međunarodni dan žena, cilj je i praćenje radnih uvjeta žene kako bi postigle što bolju ravnotežu između posla i privatnog života.

CREATE VIEW v_podaci_zaposlenika AS
SELECT z.ime, z.prezime, l.drzava, zanimanje.naziv AS zanimanje,
    COUNT(t.id) AS broj_transakcija, z.email
FROM 
    zaposlenik z
JOIN 
    zanimanje ON z.id_zanimanje = zanimanje.id
JOIN 
    lokacija l ON z.id_lokacija = l.id
LEFT JOIN 
    transakcija t ON z.id = t.id_zaposlenik AND t.datum >= DATE_SUB(CURDATE(), INTERVAL 6 MONTH)
WHERE 
    z.spol = 'F'
GROUP BY 
    z.ime, z.prezime, l.drzava, zanimanje.naziv, z.email
ORDER BY 
    z.ime ASC;
    
SELECT * FROM v_podaci_zaposlenika;
